...
#define SOIL_SENSOR_1 32 //(Plante)
#define SOIL_SENSOR_2 33 //(Étable)
#define PUMP_1 25       
#define PUMP_2 26       
#define WATER_LEVEL_1 27 
#define WATER_LEVEL_2 14 

const char* ssid = "AGJDIELEC";
const char* password = "Ouarzazate.2020";
...
const char* recipient_whatsapp = "+21265350xxxx";
...
void loop() {
    ...
    char msg[80];
    snprintf(msg, 80, "temp: %.1fC, humidity: %.1f%%", temperature, humidite);
